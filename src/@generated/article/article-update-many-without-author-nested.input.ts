...
export class ArticleUpdateManyWithoutAuthorNestedInput {
  ...
  set?: Array<Prisma.AtLeast<ArticleWhereUniqueInput, 'articleId' | 'slug'>>;

  @Field(() => [ArticleWhereUniqueInput], { nullable: true })
  @Type(() => ArticleWhereUniqueInput)
  disconnect?: Array<
    Prisma.AtLeast<ArticleWhereUniqueInput, 'articleId' | 'slug'>
  >;

  @Field(() => [ArticleWhereUniqueInput], { nullable: true })
  @Type(() => ArticleWhereUniqueInput)
  delete?: Array<Prisma.AtLeast<ArticleWhereUniqueInput, 'articleId' | 'slug'>>;
